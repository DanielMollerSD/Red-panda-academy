    ...
    private static void createTables(String url, String databaseName, String username, String password) {
        try {
            ...
            statement.executeUpdate("INSERT INTO `vraag` VALUES " +
                    "(1, 'Vraag 1?', 'Antwoord 1.1', 'Antwoord 1.2', 'Antwoord 1.3', 'Antwoord 1.4', 'A', 1), " +
                    "(2, 'Vraag 2?', 'Antwoord 2.1', 'Antwoord 2.2', 'Antwoord 2.3', 'Antwoord 2.4', 'B', 1), " +
                    "(3, 'Vraag 3?', 'Antwoord 3.1', 'Antwoord 3.2', 'Antwoord 3.3', 'Antwoord 3.4', 'C', 1)");
